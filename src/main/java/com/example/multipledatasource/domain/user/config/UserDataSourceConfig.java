package com.example.multipledatasource.domain.user.config;
...
@EnableJpaRepositories(
    ...
    basePackages = {"com.example.multipledatasource.domain.user"}
)
public class UserDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean userEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
            ...
            .packages("com.example.multipledatasource.domain.user")
